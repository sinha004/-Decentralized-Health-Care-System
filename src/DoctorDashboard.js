...
import Patient from './DoctorNewPatient';
  ...
  return (
    <Box sx={{ display: 'flex' }}>
      ...
      <Drawer variant="permanent" open={open}>
        ...
        <List>
          {['Profile', 'History', 'New Prescription', "Sign Out"].map((text, index) => (
      ...
      {/*New Patient*/}
      {displayNewPatient && <Box component="main" sx={{ flexGrow: 1, p: 3 }}> <DrawerHeader /> <Patient /> </Box>}
